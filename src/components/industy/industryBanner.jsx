                        ...
                        <div className="row justify-content-center py-5">
                            <div className="col-md-7 w-100">
                                <div className='d-flex align-items-center h5'>
                                    ...
                                    <div className='px-3'><Link to='/industries' className='nav-link'>Industries</Link></div>
                                    <i className="fa-solid fa-circle-chevron-right"></i>
                                </div>
                                <div className="h1 text-capitalize">{name ? name.split('-').join(' '): 'Served Industries'}</div>
                            </div>
                        </div>
                    </div>
                </div>
